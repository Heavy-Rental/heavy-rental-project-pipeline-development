...
Study `REST-API-CD-FEASIBILITY.md` §5 / `IMPLEMENTATION-PLAN.md` §5. Infra `HR-162` already composes REST. This repo’s Release pipeline builds `ghcr.io/<owner>/heavy-rental-rest-api:<tag>` (off PR) and a `.tar.gz` artifact.
