...
9. **This family does not compose onto guests.** It does not apply IaC, create cloud resources, or monitor production. Release still runs Packaging → DAST → Publish. Academy + paid app CD lives in `deploy-pipeline/` in this tree. Operate is after deploy (infra project).
