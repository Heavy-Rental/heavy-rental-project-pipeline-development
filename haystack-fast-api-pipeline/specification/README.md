...
| **ADR** | [`../docs/adr/`](../docs/adr/) | Why: caller gate, uv toolchain, env-driven Release image (0008), estate vs project knobs (0009), Academy-only CD, masked Vocareum keys, reused Ansible |
